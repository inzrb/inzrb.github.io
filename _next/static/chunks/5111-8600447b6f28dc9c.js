...
`}getPatchMapForMaterial(){return"ShaderMaterial"===this._type?y:_}patchShader(e,t){let r=t,n={...this.getPatchMapForMaterial(),...this._customPatchMap};return Object.keys(n).forEach(t=>{Object.keys(n[t]).forEach(o=>{w(e.main,t)&&(r=b(r,o,n[t][o]))})}),r=r.replace("void main() {",`
  ...
  `;class F extends j{constructor(e){super(F,{name:"Fresnel",...e})}}F.u_color="white",F.u_alpha=1,F.u_bias=0,F.u_intensity=1,F.u_power=2,F.u_factor=1,F.vertexShader=`
    varying vec3 v_worldPosition;
  ...
  `;class $ extends j{constructor(e){super($,{name:"Gradient",...e},e=>{e.schema.push({value:e.axes,label:"axes",options:["x","y","z"]}),e.schema.push({value:e.mapping,label:"mapping",options:Object.values(C)});let t=$.getMapping(e.mapping);e.vertexShader=e.vertexShader.replace("lamina_mapping_template",t||"local"),e.fragmentShader=e.fragmentShader.replace("axes_template",e.axes||"x")}),this.axes="x",this.mapping="local"}static getMapping(e){switch(e){default:case"local":return"position";case"world":return"(modelMatrix * vec4(position,1.0)).xyz";case"uv":return"vec3(uv, 0.)"}}}$.u_colorA="white",$.u_colorB="black",$.u_alpha=1,$.u_start=1,$.u_end=-1,$.u_contrast=1,$.vertexShader=`
		varying vec3 v_position;
  ...
  `;class L extends j{constructor(e){super(L,{name:"Matcap",...e})}}L.u_alpha=1,L.u_map=void 0,L.vertexShader=`
    varying vec3 v_position;
  ...
  `;class U extends j{constructor(e){super(U,{name:"Displace",...e},e=>{e.schema.push({value:e.type,label:"type",options:Object.values(I)}),e.schema.push({value:e.mapping,label:"mapping",options:Object.values(C)});let t=U.getNoiseFunction(e.type),r=U.getMapping(e.mapping);e.vertexVariables=e.vertexVariables.replace("lamina_mapping_template",r),e.vertexVariables=e.vertexVariables.replace("lamina_noise_template",t)}),this.type="perlin",this.mapping="local"}static getNoiseFunction(e){switch(e){default:case"perlin":return"lamina_noise_perlin";case"simplex":return"lamina_noise_simplex";case"cell":return"lamina_noise_worley";case"white":return"lamina_noise_white";case"curl":return"lamina_noise_swirl"}}static getMapping(e){switch(e){default:case"local":return"p";case"world":return"(modelMatrix * vec4(p,1.0)).xyz";case"uv":return"vec3(uv, 0.)"}}}U.u_strength=1,U.u_scale=1,U.u_offset=new a.Vector3(0,0,0),U.vertexShader=`
    ...
    `;class K extends j{constructor(e){super(K,{name:"Normal",...e})}}K.u_alpha=1,K.u_direction=new a.Vector3(1,1,1),K.vertexShader=`   
